...
- __Check torch is installed in your environment__ using reticulate::py_module_available("torch"). If __torch__ is not installed, go to your conda environment and run: `pip install torch==1.6.0 -f https://download.pytorch.org/whl/torch_stable.html`
